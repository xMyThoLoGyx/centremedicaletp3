 ...
 */
	public static function testProvider() {
		return array(
			...
			array(
				new MissingTableException(array('table' => 'patients', 'class' => 'Article', 'ds' => 'test')),
				array(
					'/<h2>Missing Database Table<\/h2>/',
					'/Table <em>patients<\/em> for model <em>Article<\/em> was not found in datasource <em>test<\/em>/'
				),
				500
			),
			array(
