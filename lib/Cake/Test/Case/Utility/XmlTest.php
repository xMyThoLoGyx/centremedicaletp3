 ...
 */
	public function testRss() {
		...
		$atomLink = array('@href' => 'http://bakery.cakephp.org/patients/rss', '@rel' => 'self', '@type' => 'application/rss+xml');
		...
		$expected = array(
			...
			'link' => 'http://bakery.cakephp.org/patients/view/alertpay-automated-sales-via-ipn',
			...
			'guid' => 'http://bakery.cakephp.org/patients/view/alertpay-automated-sales-via-ipn'
		);
		...
		$rss = array(
			'rss' => array(
				...
				'channel' => array(
					'atom:link' => array(
						'@href' => 'http://bakery.cakephp.org/patients/rss',
						'@rel' => 'self',
						'@type' => 'application/rss+xml'
					),
					'title' => 'The Bakery: ',
					'link' => 'http://bakery.cakephp.org/',
					'description' => 'Recent  Patients at The Bakery.',
					'pubDate' => 'Sun, 12 Sep 2010 04:18:26 -0500',
					'item' => array(
						array(
							'title' => 'CakePHP 1.3.4 released',
							'link' => 'http://bakery.cakephp.org/patients/view/cakephp-1-3-4-released'
						),
						array(
							'title' => 'Wizard Component 1.2 Tutorial',
							'link' => 'http://bakery.cakephp.org/patients/view/wizard-component-1-2-tutorial'
						)
					)
				)
			)
...
<channel>
	<atom:link href="http://bakery.cakephp.org/patients/rss" rel="self" type="application/rss+xml"/>
	<title>The Bakery: </title>
	<link>http://bakery.cakephp.org/</link>
	<description>Recent  Patients at The Bakery.</description>
	<pubDate>Sun, 12 Sep 2010 04:18:26 -0500</pubDate>
	<item>
		<title>CakePHP 1.3.4 released</title>
		<link>http://bakery.cakephp.org/patients/view/cakephp-1-3-4-released</link>
	</item>
	<item>
		<title>Wizard Component 1.2 Tutorial</title>
		<link>http://bakery.cakephp.org/patients/view/wizard-component-1-2-tutorial</link>
	</item>
</channel>
</rss>
XML;
