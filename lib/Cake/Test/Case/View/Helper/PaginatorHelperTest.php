 ...
 */
	public function testPassedArgsMergingWithUrlOptions() {
		...
		Router::parse('/');
		Router::setRequestInfo(array(
			array('plugin' => null, 'controller' => 'patients', 'action' => 'index', 'pass' => array('2'), 'named' => array('foo' => 'bar'), 'url' => array('url' => 'patients/index/2/foo:bar')),
			array('base' => '/', 'here' => '/patients/', 'webroot' => '/')
		));
		...
		$result = $this->Paginator->sort('title');
		$expected = array(
			'a' => array('href' => '/patients/index/2/foo:bar/sort:title/direction:asc?x=y'),
			'Title',
			'/a'
		);
		$this->assertTags($result, $expected);
		...
		$expected = array(
			...
			' | ',
			array('span' => array()), array('a' => array('href' => '/patients/index/2/page:2/foo:bar?x=y')), '2', '/a', '/span',
			' | ',
			array('span' => array()), array('a' => array('href' => '/patients/index/2/page:3/foo:bar?x=y')), '3', '/a', '/span',
			' | ',
			array('span' => array()), array('a' => array('href' => '/patients/index/2/page:4/foo:bar?x=y')), '4', '/a', '/span',
			' | ',
			array('span' => array()), array('a' => array('href' => '/patients/index/2/page:5/foo:bar?x=y')), '5', '/a', '/span',
			' | ',
			array('span' => array()), array('a' => array('href' => '/patients/index/2/page:6/foo:bar?x=y')), '6', '/a', '/span',
			' | ',
			array('span' => array()), array('a' => array('href' => '/patients/index/2/page:7/foo:bar?x=y')), '7', '/a', '/span',
		);
		$this->assertTags($result, $expected);
		...
		$expected = array(
			'span' => array('class' => 'next'),
			'a' => array('href' => '/patients/index/2/page:2/foo:bar?x=y', 'rel' => 'next'),
			'Next',
			'/a',
			'/span'
		);
 ...
 */
	public function testPassedArgsMergingWithUrlOptionsParamTypeQuerystring() {
		...
		$result = $this->Paginator->sort('title');
		$expected = array(
			'a' => array('href' => '/patients/index/2/foo:bar?x=y&amp;sort=title&amp;direction=asc'),
			'Title',
			'/a'
		);
		$this->assertTags($result, $expected);
		...
		$expected = array(
			array('span' => array('class' => 'current')), '1', '/span',
			' | ',
			array('span' => array()), array('a' => array('href' => '/patients/index/2/foo:bar?x=y&amp;page=2')), '2', '/a', '/span',
			' | ',
			array('span' => array()), array('a' => array('href' => '/patients/index/2/foo:bar?x=y&amp;page=3')), '3', '/a', '/span',
			' | ',
			array('span' => array()), array('a' => array('href' => '/patients/index/2/foo:bar?x=y&amp;page=4')), '4', '/a', '/span',
			' | ',
			array('span' => array()), array('a' => array('href' => '/patients/index/2/foo:bar?x=y&amp;page=5')), '5', '/a', '/span',
			' | ',
			array('span' => array()), array('a' => array('href' => '/patients/index/2/foo:bar?x=y&amp;page=6')), '6', '/a', '/span',
			' | ',
			array('span' => array()), array('a' => array('href' => '/patients/index/2/foo:bar?x=y&amp;page=7')), '7', '/a', '/span',
		);
		$this->assertTags($result, $expected);
		...
		$expected = array(
			'span' => array('class' => 'next'),
			'a' => array('href' => '/patients/index/2/foo:bar?x=y&amp;page=2', 'rel' => 'next'),
			'Next',
			'/a',
			'/span'
		);
