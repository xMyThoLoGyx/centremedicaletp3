 ...
 */
	public function testMeta() {
		...
		$result = $this->Html->meta('atom', array('controller' => 'posts', 'ext' => 'xml'), array('link' => '/patients.rss'));
		$this->assertTags($result, array('link' => array('href' => 'preg:/.*\/patients\.rss/', 'type' => 'application/atom+xml', 'title' => 'atom')));
