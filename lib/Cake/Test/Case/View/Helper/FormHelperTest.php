 ...
 */
	public function testSecuredFormUrlIgnoresHost() {
		...
		$this->Form->create('Address', array(
			'url' => array('controller' => 'patients', 'action' => 'view', 1, '?' => array('page' => 1))
		));
		$result = $this->Form->secure();
		$this->assertContains($expected, $result);

		$this->Form->create('Address', array('url' => 'http://localhost/patients/view/1?page=1'));
		$result = $this->Form->secure();
		$this->assertContains($expected, $result, 'Full URL should only use path and query.');

		$this->Form->create('Address', array('url' => '/patients/view/1?page=1'));
		$result = $this->Form->secure();
		$this->assertContains($expected, $result, 'URL path + query should work.');

		$this->Form->create('Address', array('url' => '/patients/view/1'));
		$result = $this->Form->secure();
 ...
 */
	public function testSecuredFormUrlWorksWithNamedParameter() {
		...
		$this->Form->create('Address', array(
			'url' => array('controller' => 'patients', 'action' => 'view', 1, 'type' => 'red')
		));
		$result = $this->Form->secure();
		$this->assertContains($expected, $result);
	}
 ...
 */
	public function testSecuredFormUrlHasHtmlAndIdentifier() {
		...
		$this->Form->create('Address', array('url' => 'http://localhost/patients/view?page=1&limit=10&html=%3C%3E%22#result'));
		$result = $this->Form->secure();
		$this->assertContains($expected, $result, 'Full URL should only use path and query.');

		$this->Form->create('Address', array('url' => '/patients/view?page=1&limit=10&html=%3C%3E%22#result'));
		$result = $this->Form->secure();
		$this->assertContains($expected, $result, 'URL path + query should work.');
	}
