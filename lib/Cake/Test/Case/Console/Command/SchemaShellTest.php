 ...
 */
	public function testGenerateWithPlugins() {
		...
		$this->assertNotRegExp('/public \$patients/', $contents);
		CakePlugin::unload();
	}
 ...
 */
	public function testUpdateWithTable() {
		...
		$this->Shell->args = array('SchemaShellTest', 'patients');
		$this->Shell->startup();
		...
		$this->Shell->expects($this->once())
			->method('_run')
			->with($this->arrayHasKey('patients'), 'update', $this->isInstanceOf('CakeSchema'));
