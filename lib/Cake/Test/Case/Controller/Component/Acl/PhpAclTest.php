 ...
 */
	public function testCheck() {
		...
		$this->assertTrue($this->Acl->check('User/stan', 'controllers/patients/edit'));
		$this->assertTrue($this->Acl->check('stan', 'controllers/patients/add'));
		$this->assertTrue($this->Acl->check('stan', 'controllers/patients/publish'));
		$this->assertFalse($this->Acl->check('User/stan', 'controllers/patients/delete'));
		$this->assertFalse($this->Acl->check('accounting', 'controllers/patients/edit'));
		$this->assertFalse($this->Acl->check('accounting', 'controllers/patients/add'));
		$this->assertFalse($this->Acl->check('role/accounting', 'controllers/patients/publish'));
	}
