 ...
 */
	public function testUrlGenerationWithExtensions() {
		Router::parse('/');
		$result = Router::url(array('plugin' => null, 'controller' => 'patients', 'action' => 'add', 'id' => null, 'ext' => 'json'));
		$expected = '/patients/add.json';
		$this->assertEquals($expected, $result);

		$result = Router::url(array('plugin' => null, 'controller' => 'patients', 'action' => 'add', 'ext' => 'json'));
		$expected = '/patients/add.json';
		$this->assertEquals($expected, $result);

		$result = Router::url(array('plugin' => null, 'controller' => 'patients', 'action' => 'index', 'id' => null, 'ext' => 'json'));
		$expected = '/patients.json';
		$this->assertEquals($expected, $result);

		$result = Router::url(array('plugin' => null, 'controller' => 'patients', 'action' => 'index', 'ext' => 'json'));
		$expected = '/patients.json';
		$this->assertEquals($expected, $result);
	}
