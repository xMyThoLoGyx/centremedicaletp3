 ...
 */
	public function testRouteCompilingWithParamPatterns() {
		...
		$this->assertRegExp($result, '/cze/patients/view/1');
		$this->assertNotRegExp($result, '/language/patients/view/2');
		$this->assertNotRegExp($result, '/eng/patients/view/name-of-article');
