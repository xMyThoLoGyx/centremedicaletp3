...
<div id="page-container" class="row">
    ...
    <div id="sidebar" class="col-sm-3">
        ...
        <div class="actions">
            ...
            <ul class="list-group">
                <li class="list-group-item"><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Rencontre.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Rencontre.id'))); ?></li>
            </ul><!-- /.list-group -->
        </div><!-- /.actions -->
